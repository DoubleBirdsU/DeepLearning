...
data_root = '/home/wnyl/.dataset/VOC2012/yolo_data'
train_annotation_dir = os.path.join(data_root, "train/labels")
val_annotation_dir = os.path.join(data_root, "val/labels")
